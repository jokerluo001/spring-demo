...
//@Service("apispace")
public class ApiSpaceWeatherService implements WeatherService {
    ...
    * */
    ...
    private void saveWeather(String city) {
        ...
        String requestUrl = url.replace("{city}", city);
        Map map = httpUtil.callApiSpaceWeatherApi(url, HttpMethod.GET,city, params, "ApiSpace");
        if (map != null) {
